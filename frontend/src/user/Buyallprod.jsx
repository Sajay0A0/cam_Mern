...
const closePopup = () => {
  ...
  navigate('/placedall', { state: { orderedProducts: cartProducts } });
    ...
    return(
        ...
        <div style={{display:'flex',flexBasis:'column',gap:'20px',paddingLeft:'0%',}}>
          <table style={{marginLeft:'5px',marginTop:'20px'}}>
            {cartProducts.map((val)=>(
                <tr  key={val._id}
                style={{border:'solid 1px #BB96F7',borderRadius:'19px',marginTop:'0',maxWidth:'550px',width:'450px',display:'flex',flexWrap:'wrap',paddingTop:'0',marginTop:'5px',paddingLeft:'10px',marginLeft:'20px'}}>
                     <th scope="col"> <img src={val.image} style={{ width: "60px" }} alt="pic" /></th>
        ...
        <div className="upi-drop" style={{ border: 'solid 1px black', borderRadius: '10px', margin: '20px 10px 0 10px' }}>
          ...
          <div className="upi-drp">
            <div className="hello" style={{ border: 'solid 1px #ddd',borderRadius:'8px' }}>
                            <input type="radio" id="html" name="fav_language" value="HTML" />
                            <label htmlFor="html">Google pay</label>
                            <br />
                            <input type="radio" id="css" name="fav_language" value="CSS" />
                            <label htmlFor="css">Phone pay</label>
                            <br />
