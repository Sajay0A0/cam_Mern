...
const cartProducts = cart.map(cartItem => {
  ...
  const totalPrice = (productData && productData.price) ? (productData.price * cartItem.quantity) : 0;
  return {
    ...productData,
    ...
    <div>
      ...
      <section>
        ...
        <form><section>
          ...
          <input className="text-1" type="text" placeholder="email" value={userEmail} />
          ...
          <button className='bbtn-1' onClick={addAddress}>ADD</button>
            </section>
        </form>
