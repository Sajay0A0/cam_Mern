...
export default function Mirrlesslens(){

  const {product,cart,setCart,like,setLike}=useContext(myContext)
  const navigate=useNavigate()
  const email=localStorage.getItem("userEmail")

    const Mirrlesslens=product.filter((p)=>
    p.specify==="Mirrlesslens")
    console.log("Mirrlesslens",product,Mirrlesslens);
    ...
    return(
        <div>
          ...
          Mirrorless <br /> Lenses
        </h1>
        <img 
          src="https://images.pexels.com/photos/5687130/pexels-photo-5687130.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
