...
import { Checkbox } from "@mui/material";
 ...
 export default function Mediumformat(){

  const {product,cart,setCart,like,setLike}=useContext(myContext)
  const navigate=useNavigate()
  const email=localStorage.getItem("userEmail")

    const Mediumformat=product.filter((p)=>
    p.specify==="Mediumformat")
    console.log("Mediumformat",product,Mediumformat);
    ...
    return(
        ...
        <img 
          src="https://images.pexels.com/photos/9808446/pexels-photo-9808446.jpeg?auto=compress&cs=tinysrgb&w=600"
